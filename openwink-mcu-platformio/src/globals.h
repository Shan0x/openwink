...
#define AUX_1_BUTTON_INPUT GPIO_NUM_7
#define AUX_2_BUTTON_INPUT GPIO_NUM_6
// #define FLASHTOPASS_BUTTON_INPUT GPIO_NUM_6
#define MAX_BUTTONS 3 // The max amount of buttons
...
{
    vector<HeadlightCommand> commands;
} CustomCommand;
